...
const StockExchangeTableBody = ( props ) => {
    const {
        singleProduct,
        index,
        updateProducts,
    ...
    return (
        <tr key={index} className='align-middle'>
            ...
            <td>
             ...
             <td>
                <h4 className='fs-6 mb-0'>{singleProduct.product_price}</h4>
            </td>
...
export default connect( mapStateToProps, { productSalesDropdown, posAllProduct } )( StockExchangeTableBody );
